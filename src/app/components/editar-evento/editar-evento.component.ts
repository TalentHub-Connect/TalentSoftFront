...
export class EditarEventoComponent implements OnInit {
  ...
  editEvento() {
    ...
    if (this.inputdata) {
      ...
      const newNameEvent = this.editForm.get('email')?.value || this.currentEvento.email;
      const newDescription = this.editForm.get('university')?.value || this.currentEvento.university;
