export const environment = {
  ...
  //authURL: 'https://canelaauthh-qa.up.railway.app/api/talentsoft/auth',
  ...
  RECLUTAMIENTO:'https://talentsoftreclutamientospring-production.up.railway.app',  secretKey: 'ThisIsASecretKey'
};
